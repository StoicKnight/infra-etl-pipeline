...
from src.services.netbox.models.device import (
    Device,
    DeviceCreate,
    DeviceList,
    DeviceUpdate,
...
class DevicesEndpoints:
    ...
    async def create_device(self, device: DeviceCreate) -> Optional[Device]:
    ...
    async def overwrite_device(self, device: DeviceCreate, device_id: int) -> Device:
        url: str = f"/api/dcim/devices/{device_id}/"
        payload = device.model_dump(exclude_unset=True)
        try:
    ...
    async def update_device(self, device: DeviceUpdate, device_id: int) -> Device:
        url: str = f"/api/dcim/devices/{device_id}/"
        payload = device.model_dump(exclude_unset=True)
        try:
